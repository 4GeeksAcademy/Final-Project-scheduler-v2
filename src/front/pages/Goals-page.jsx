      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-xl p-6 md:p-10 space-y-6">
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <input
            type="number"
            min="1"
            className="w-24 p-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#7FC1E0] text-center transition-colors duration-200"
            placeholder="Target"
            value={newGoalTarget}
          ...
          <button
            onClick={addGoal}
            className="bg-[#7FC1E0] text-white font-semibold py-3 px-6 rounded-xl shadow-md hover:bg-[#5fa9cb] transition-colors duration-200"
          >
            Add Goal
          </button>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 mt-4 md:mt-0">
                    <div className="w-40 bg-gray-200 rounded-full h-3">
                      <div
                        className={`h-full rounded-full transition-all duration-300 ${isComplete ? 'bg-green-500' : 'bg-[#7FC1E0]'}`}
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="bg-[#7FC1E0] text-white font-semibold py-2 px-4 rounded-full transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                        disabled={isComplete}
                      >
                        Add
                      </button>
