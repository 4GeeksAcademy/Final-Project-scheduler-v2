                ...
                <div className="card shadow-lg border-0" style={{ borderRadius: "1rem", overflow: "hidden" }}>
                    <div className="row d-flex justify-content-center p-5">
                        <div className="mt-5 col-5">
                            <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 tracking-tight mb-2">Create Event:</h1>
                            ...
                            <div className="dropdown">
                                <button className="btn rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-describedby="publicHelp" style={{ background: "#7FC1E0", color: "white" }}>
                            ...
                            <div className="dropdown">
                                <button className="btn rounded-pill dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-describedby="repeatHelp" style={{ background: "#7FC1E0", color: "white" }}>
                                    {repeatType}
                                </button>
                                <ul className="dropdown-menu border-dark border-opacity-50">
