...
app.config["JWT_SECRET_KEY"] = os.getenv(
    "JWT_SECRET_KEY") or os.getenv("FLASK_APP_KEY", "dev-secret")
jwt = JWTManager(app)

# ---------- CORS ----------
# Point this to your frontend (3000) and allow your backend URL too.
FRONTEND_ORIGIN = os.getenv(
    "FRONTEND_ORIGIN", "http://localhost:3000").rstrip("/")
API_URL = os.getenv("VITE_BACKEND_URL", "http://localhost:3001").rstrip("/")
CORS(app, resources={
     r"/api/*": {"origins": [FRONTEND_ORIGIN, "http://127.0.0.1:3000", API_URL]}})
